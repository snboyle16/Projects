...
;;; PROBLEM 6
    ...
    (define radius 10)
    (define volume_sphere (* (* (/ 4 3) 3.14159) (* radius radius radius)))
    volume_sphere
...
;;; PROBLEM 7
    ...
    (eval (cons 'cdr '( '(1 (3 4 . (five . six))))))
    ; expect ((3 4 five . six))

;;; PROBLEM 8
    (begin (eval (cons 'cdr '('(1 (3 4 . (five . six)))))) (newline) (print 8) '(4 5 6))
    ; expect (4 5 6)

    (define x (begin (display 3) (+ 2 3)))
    ; expect 3x

    (define x (begin (+ 2 3) (+ 5 6)))
    ; expect x
...
;;; PROBLEM 9
    ...
    (lambda x (begin x (+ x 3)))
    ; expect (lambda x (begin x (+ x 3)))

    (lambda x (quote x))
    ; expect (lambda x (quote x))

;;; PROBLEM 10
    (define x (+ 4 2))
    ; expect x

    (define (y x) (begin x (+ x 3)))
    ; expect y
...
;;; PROBLEM 13
    (and (or 1 False (/ 1 0)) True False (/ 1 0))
    ; expect False

    (and (begin (+ 1 0) (or) (- 1 0)) (or))
    ; expect False
