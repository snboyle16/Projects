...
def user_rating(user, restaurant_name):
    ...
    # list of restaurants reviewed by a user
    user_review = reviewed_by_user[restaurant_name]
    # returns the review in dict reviewed_by_user for which the key is
    # restaurant_name 
...
def make_restaurant(name, location, categories, price, reviews):
    ...
    # BEGIN Question 1
    restaurant_reviews = [review_rating(a) for a in reviews]
    # END Question 1
    return {
        'name': name,
        'location': location,
